    ...
    return {
        ...
        openStream(channelData) {
            ...
            const player = {
                ...
                aio_item_id: channelData.aio_item_id ?? null,
                aio_integration_id: channelData.aio_integration_id ?? null,
                episode_number: channelData.episode_number ?? null,
                episode_title: channelData.episode_title || '',
                thumbnail_url: channelData.thumbnail_url || '',
                backdrop_url: channelData.backdrop_url || '',
                rating: channelData.rating || '',
                year: channelData.year || '',
                plot: channelData.plot || '',
