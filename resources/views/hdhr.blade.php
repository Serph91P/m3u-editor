...
<body>
    <div class="container">
        ...
        <ol>
            <li>
                Open Plex Web App by navigating to <a href="https://app.plex.tv/" target="_blank">Plex</a> in your
                browser.
            </li>
            ...
            <li>
                Enter the following HDHomeRun tuner address manually:
                <strong>{{ \App\Facades\PlaylistFacade::getUrls($playlist)['hdhr'] }}</strong>
            </li>
            ...
            <ul>
                <li>
                    If you've added an EPG and mapped it to this playlist, you can also manually add the EPG address:
                    <strong>{{ \App\Facades\PlaylistFacade::getUrls($playlist)['epg'] }}</strong>
                </li>
            </ul>
