<x-filament-panels::page>
    ...
    <div class="space-y-6">
        <section class="via-primary-50/20 dark:via-primary-950/20 overflow-hidden rounded-3xl border border-gray-200/80 bg-gradient-to-br from-white to-white shadow-sm dark:border-gray-800 dark:from-gray-950 dark:to-gray-950">
            <div class="grid gap-6 px-6 py-6 lg:grid-cols-[minmax(0,1.2fr)_minmax(280px,0.8fr)] lg:px-8">
                <div class="space-y-4">
                    <div class="flex flex-wrap items-center gap-3">
                        ...
                        @if ($run->dry_run)
                            <span class="bg-primary-50 text-primary-700 ring-primary-200 dark:bg-primary-950/40 dark:text-primary-300 dark:ring-primary-800 inline-flex items-center rounded-full px-3 py-1 text-sm font-medium ring-1 ring-inset">
                                {{ __('Dry run') }}
                            </span>
                        @endif
                        <span class="inline-flex items-center rounded-full bg-gray-100 px-3 py-1 text-sm font-medium text-gray-700 ring-1 ring-gray-200 ring-inset dark:bg-gray-900 dark:text-gray-300 dark:ring-gray-800">
                            {{ \Illuminate\Support\Str::headline($run->trigger) }}
                        </span>
                    </div>

                    <div>
                        <p class="text-primary-600 dark:text-primary-300 text-sm font-medium tracking-[0.24em] uppercase">
                            {{ __('Plugin run detail') }}
                        </p>
                    ...
                    <div class="grid gap-3 sm:grid-cols-1">
                        <div class="rounded-2xl border border-gray-200 bg-white/80 p-4 backdrop-blur dark:border-gray-800 dark:bg-gray-900/80">
                            <div class="text-[11px] font-semibold tracking-[0.18em] text-gray-500 uppercase dark:text-gray-400">
                                {{ __('Invocation') }}
                            </div>
                        ...
                        <div class="rounded-2xl border border-gray-200 bg-white/80 p-4 backdrop-blur dark:border-gray-800 dark:bg-gray-900/80">
                            ...
                            <div class="mt-3 h-2 overflow-hidden rounded-full bg-gray-100 dark:bg-gray-800">
                                <div
                                    ...
                                    style="width: {{ max(2, $progress) }}%"
                                ></div>
                            </div>
                            <div class="mt-2 text-xs text-gray-500 dark:text-gray-400">
                                {{ $progress }}% {{ __('recorded progress.') }}
                            </div>
                        </div>
                        <div class="rounded-2xl border border-gray-200 bg-white/80 p-4 backdrop-blur dark:border-gray-800 dark:bg-gray-900/80">
                            <div class="text-[11px] font-semibold tracking-[0.18em] text-gray-500 uppercase dark:text-gray-400">
                ...
                <div class="grid gap-3 sm:grid-cols-2 lg:grid-cols-1">
                    <div class="rounded-2xl border border-gray-200 bg-white/90 p-5 shadow-xs dark:border-gray-800 dark:bg-gray-900/90">
                        ...
                        <dl class="mt-4 space-y-3 text-sm text-gray-600 dark:text-gray-300">
                            <div>
                                <dt class="text-xs tracking-wide text-gray-400 uppercase dark:text-gray-500">
                                    {{ __('Queued') }}
                                </dt>
        ...
        <section class="grid gap-6 xl:grid-cols-[minmax(0,1fr)_380px]">
                ...
                <div class="flex items-center justify-between gap-3">
                    <div>
                        ...
                        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                            {{ __('Latest persisted log messages for this run.') }}
                        </p>
                    </div>
                </div>
                        ...
                        @foreach ($this->logs as $log)
                            <div class="rounded-2xl border border-gray-200 bg-gray-50/70 p-4 dark:border-gray-800 dark:bg-gray-950/60">
                                <div class="flex flex-wrap items-center gap-2">
                                    <span class="inline-flex rounded-full bg-gray-900 px-2.5 py-1 text-[11px] font-semibold tracking-[0.18em] text-white uppercase dark:bg-gray-100 dark:text-gray-900">
                                        {{ strtoupper($log->level ?? 'info') }}
                                    </span>
                                    <span class="text-xs text-gray-500 dark:text-gray-400">{{ $fmt->format($log->created_at) }}</span>
                                </div>
            ...
            <div class="space-y-6">
                ...
                <div class="rounded-3xl border border-gray-200 bg-white p-5 shadow-sm dark:border-gray-800 dark:bg-gray-900">
                    ...
                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                        The persisted result payload returned by the plugin.
                    </p>
                ...
                <div class="rounded-3xl border border-gray-200 bg-white p-5 shadow-sm dark:border-gray-800 dark:bg-gray-900">
                    ...
                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                        Checkpoint data used for long-running or resumed work.
                    </p>
