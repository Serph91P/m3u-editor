<x-filament-widgets::widget class="fi-filament-info-widget">
    <x-filament::section>
        <div class="flex items-center gap-x-3">
            ...
            <div class="flex-1">
                <h2 class="grid flex-1 text-base leading-6 font-semibold text-gray-950 dark:text-white">Donate</h2>

                <p class="text-sm text-gray-500 dark:text-gray-400">Support this project by donating</p>
            </div>
