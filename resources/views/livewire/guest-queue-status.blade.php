                ...
                <div class="py-3 first:pt-0 last:pb-0">
                    <div class="flex items-start justify-between gap-3">
                        ...
                        <div class="flex shrink-0 items-center gap-1">
                            <x-filament::badge :color="$badge['color']"> {{ __($badge['label']) }} </x-filament::badge>
                    ...
                    <div class="mt-1 flex items-center gap-3 text-xs text-gray-500 dark:text-gray-500">
                        ...
                        @if ($item['protocol'] ?? null)
                            <span class="tracking-wide text-gray-400 uppercase dark:text-gray-600">
                        ...
                        @else
                            <span class="ml-auto text-xs text-gray-400 dark:text-gray-600">
                                {{ $item['integration_name'] }} &middot; {{ $item['requested_at'] ? \Carbon\Carbon::parse($item['requested_at'])->diffForHumans() : '' }}
                            </span>
                        @endif
                    </div>
